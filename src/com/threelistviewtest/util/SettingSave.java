...
public class SettingSave
{
  ...
  public static boolean saveSelectCity(Context paramContext, int paramInt)
  {
    SharedPreferences.Editor localEditor = paramContext.getSharedPreferences("data", 0).edit();
    localEditor.putInt("cityId", paramInt);
    localEditor.commit();
    return true;
  }

  public static boolean saveSelectCounty(Context paramContext, int id)
  {
    SharedPreferences.Editor localEditor = paramContext.getSharedPreferences("data", 0).edit();
    localEditor.putInt("id", id);
    localEditor.commit();
    return true;
  }
